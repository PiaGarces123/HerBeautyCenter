...
<div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: var(--radius-xl, 1rem); background-color: #ffffff !important;">
            <div class="modal-header border-0 pb-0 d-flex flex-column align-items-center position-relative">
                <button type="button" class="btn-close position-absolute" style="top: 1rem; right: 1rem;" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                <img src="<?= base_url('public/assets/media/logoText.jpeg') ?>" alt="Her Beauty Center Logo" style="height: 60px; margin-top: 0.5rem; margin-bottom: 1rem;">
                <h2 class="modal-title fs-4 fw-bold text-center w-100" id="loginModalLabel" style="color: #50453b;">Iniciar Sesión</h2>
            </div>
            <div class="modal-body pt-2">
                <form id="loginForm" novalidate>
                    ...
                    <button type="submit" class="btn btn-pink w-100 btn-lg mt-2 fw-semibold" id="loginSubmitBtn">Ingresar</button>
                    <p class="text-center text-muted mt-3 mb-0" style="font-size: 0.9rem;">
                        ¿No tienes cuenta? <a href="#" id="switchToRegister" class="text-decoration-none fw-bold text-pink">Regístrate</a>
                    </p>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: var(--radius-xl, 1rem); background-color: #ffffff !important;">
            <div class="modal-header border-0 pb-0 d-flex flex-column align-items-center position-relative">
                <button type="button" class="btn-close position-absolute" style="top: 1rem; right: 1rem;" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                <img src="<?= base_url('public/assets/media/logoText.jpeg') ?>" alt="Her Beauty Center Logo" style="height: 60px; margin-top: 0.5rem; margin-bottom: 1rem;">
                <h2 class="modal-title fs-4 fw-bold text-center w-100" id="registerModalLabel" style="color: #50453b;">Crear Cuenta</h2>
            </div>
            <div class="modal-body pt-2">
                <form id="registerForm" novalidate>
                    ...
                    <button type="submit" class="btn btn-pink w-100 btn-lg mt-2 fw-semibold" id="registerSubmitBtn">Registrarse</button>
                    <p class="text-center text-muted mt-3 mb-0" style="font-size: 0.9rem;">
                        ¿Ya tienes cuenta? <a href="#" id="switchToLogin" class="text-decoration-none fw-bold text-pink">Inicia sesión</a>
                    </p>
                </form>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow-lg text-center" style="border-radius: var(--radius-xl, 1rem);">
            ...
            <div class="modal-body pt-0">
                ...
                <p class="text-muted mb-4" id="genericConfirmMessage">¿Estás seguro de que deseas continuar con esta acción?</p>
                <div class="d-flex gap-2 justify-content-center">
                    <button type="button" class="btn btn-outline-secondary px-4" id="genericConfirmCancel" data-bs-dismiss="modal">Cancelar</button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow-lg text-center" style="border-radius: var(--radius-xl, 1rem);">
            ...
            <div class="modal-body pt-0">
                ...
                <div class="d-grid">
                    <button type="button" class="btn btn-success btn-lg" id="successModalBtn" data-bs-dismiss="modal">Aceptar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content border-0 shadow-lg text-center" style="border-radius: var(--radius-xl, 1rem);">
            ...
            <div class="modal-body pt-0">
                ...
                <p class="text-muted mb-4" id="errorModalMessage">Ocurrió un error al procesar tu solicitud. Por favor intentá nuevamente.</p>
                <div class="d-grid">
                    <button type="button" class="btn btn-danger btn-lg" id="errorModalBtn" data-bs-dismiss="modal">Entendido</button>
                </div>
            </div>
        </div>
    </div>
